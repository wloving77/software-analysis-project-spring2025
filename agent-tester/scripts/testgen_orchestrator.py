...
def generate_tests_with_gemini(num_tests=10, additional_prompt=""):
    ...
    header = (
        ...
        "Please make these tests as large and complex as possible so that they function well for the program under test and maximize code coverage.\n\n"
        "Example Format:\n\n"
        f"{SEED_DELIMITER}\n"
        "seed 1\n"
        f"{SEED_DELIMITER}\n"
    ...
    for i, case in enumerate(test_cases):
        ...
        test_file.write_text(case.strip("```") + "\n")
